    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language_slug', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='package.Technology')),
                ('technology_slug', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='package.Language')),
            ],
        ),
    ]
